			...
			<div class="table-responsive">
				<datatables:table cdn="true" id="klienci" data="${clientsList}"
					...
					<datatables:column title="Nazwa klienta">
						...
						<br>
						<font size="-2"> <c:out value="${cl.ulica} ${cl.nrBudynku}"></c:out>
							<c:if test="${not empty cl.nrLokalu}">/${cl.nrLokalu}</c:if>
							<c:out value=", ${cl.kodPocztowy} ${cl.miasto}, NIP: ${cl.nip}"></c:out>
						</font>
					</datatables:column>
