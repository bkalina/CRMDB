		...
		<div id="page-wrapper">
			...
			<div class="panel-body"
				...
				<sf:form class="form-horizontal" method="post"
					action="${pageContext.request.contextPath}/dodajKlientaDO" commandName="clientModel" >
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 85%;">
							<sf:input type="text" class="form-control" path="nazwaFirmy" name="nazwaFirmy"
								placeholder="Nazwa firmy" /><sf:errors path="nazwaFirmy" cssClass="error"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control"  path="imie" name="imie"
								placeholder="Imię" /><sf:errors path="imie" cssClass="error"/>
						</div>
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="nazwisko" name="nazwisko"
								placeholder="Nazwisko" /><sf:errors path="nazwisko" cssClass="error"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="ulica" name="ulica"
								placeholder="Ulica" /><sf:errors path="ulica" cssClass="error"/>
						</div>
						...
						<div class="col-sm-1" style="width: 12%;">
							<sf:input type="text" class="form-control" path="nrBudynku" name="nrBudynku"
								placeholder="Budynek" /><sf:errors path="nrBudynku" cssClass="error"/>
						</div>
						...
						<div class="col-sm-1" style="width: 12%;">
							<sf:input type="text" class="form-control" path="nrLokalu" name="nrLokalu"
								placeholder="Lokal" /><sf:errors path="nrLokalu" cssClass="error"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="kodPocztowy" name="kodPocztowy"
								placeholder="Kod pocztowy" /><sf:errors path="kodPocztowy" cssClass="error"/>
						</div>
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="miasto" name="miasto"
								placeholder="Miasto" /><sf:errors path="miasto" cssClass="error"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="nip" name="nip"
								placeholder="NIP" /><sf:errors path="nip" cssClass="error"/>
						</div>
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="regon" name="regon"
								placeholder="Regon" /><sf:errors path="regon" cssClass="error"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="telKontaktowy" name="telKontaktowy"
								placeholder="Telefon kontaktowy" /><sf:errors path="telKontaktowy" cssClass="error"/>
						</div>
						<label for="email" class="col-sm-2 control-label"
							style="width: 15%;">Email</label>
						<div class="col-sm-4" style="width: 35%;">
							<sf:input type="text" class="form-control" path="email" name="email"
								placeholder="Email" /><sf:errors path="email" cssClass="error"/>
						</div>
